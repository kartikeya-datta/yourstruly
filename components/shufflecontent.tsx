...
const funFacts = [
    ...
    "I always love meetings new people and so attending wedding. A lot of food and a lot of people.",
    "Orange is my favourite colour. But I started loving blue too. Still orange is my favourite😁.",
    "I listen to all kind of music drop me your favourite song. Will definetly listed to it.",
    "I speak English, Hindi and Telugu. Can understand Punjabi an Kannadam too. Trying to learn Spanish.",
...
const ShuffleButton = () => {
  const [currentFact, setCurrentFact] = useState(funFacts[0]); // Initially display the first fact

  // Shuffle the facts when the button is clicked
  const handleShuffle = () => {
    const randomFact = funFacts[Math.floor(Math.random() * funFacts.length)];
    setCurrentFact(randomFact); // Set the new fact
  };
